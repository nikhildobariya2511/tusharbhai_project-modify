...
import { Report, PagedResponse } from "../types/report";
...
export function useUploadPdf() {
  ...
  return useMutation<
    any,
    Error,
    { file: File; proportions?: any; onUploadProgress?: (e: any) => void }
  >({
...
export function useUpdateReport() {
  ...
  return useMutation<
    Report,
    Error,
    { reportNumber: string; body: Partial<Report> }
  >({
    mutationFn: ({ reportNumber, body }) =>
      apiClient.updateReport(reportNumber, body),
