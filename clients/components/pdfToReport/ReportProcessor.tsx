  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const result = await uploadPdfMutation.mutateAsync({
        file: uploadedFile!,
        proportions, // pass the same proportions object
      ...
      // build filename + generate pdf from InvoicePDF
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(val) => handleProportionChange('size', val)}
                    value={proportions.size}
                  >
